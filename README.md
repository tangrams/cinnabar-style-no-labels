...
1. Update your copy of the scene file on [line 450](https://github.com/tangrams/cinnabar-style-no-labels/blob/gh-pages/cinnabar-style-no-labels.yaml#L450) to reference the API key you created in Step 3 in the **Sign up** section above. 
